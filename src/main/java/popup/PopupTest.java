...
public class PopupTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            verifyPopup(driver, popup1Xpath);
            ...
            for (WebElement trigger : popup2Triggers) {
                ...
                verifyPopup(driver, popup2Xpath);
            }
            ...
            WebElement popup = driver.findElement(By.xpath(popup3Xpath));
            boolean isPopupDisplayed = popup.isDisplayed();
            System.out.println("Popup is displayed: " + isPopupDisplayed);

            // Kiểm tra nội dung của popup
            String popupText = popup.getAttribute("data-html").trim();
    ...
    private static void verifyPopup(WebDriver driver, String popupXPath) {
        ...
        // Kiểm tra nội dung của popup
        String popupText = popup.getAttribute("data-content").trim();
        System.out.println("Popup content: " + popupText);
